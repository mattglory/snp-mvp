;; StackSwap V1 Strategy - TESTNET VERSION
;; Simplified for testnet deployment

;; Error codes
(define-constant ERR_UNAUTHORIZED (err u7500))
(define-constant ERR_INSUFFICIENT_BALANCE (err u7501))
(define-constant ERR_STRATEGY_INACTIVE (err u7502))
(define-constant ERR_INVALID_AMOUNT (err u7503))

;; Config
(define-constant MIN_DEPOSIT u1000000)
(define-constant SIMULATED_APY u580) ;; 5.8% APY
...
;; Read-only
(define-read-only (get-name) (ok "StackSwap Farming (Testnet)"))
