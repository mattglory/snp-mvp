;; Velar Farm Strategy V1 - TESTNET VERSION
;; Simplified for testnet deployment

;; Error codes
(define-constant ERR_UNAUTHORIZED (err u7100))
(define-constant ERR_INSUFFICIENT_BALANCE (err u7101))
(define-constant ERR_STRATEGY_INACTIVE (err u7102))
(define-constant ERR_INVALID_AMOUNT (err u7103))

;; Config
(define-constant MIN_DEPOSIT u1000000)
(define-constant SIMULATED_APY u600) ;; 6% APY
...
;; Read-only
(define-read-only (get-name) (ok "Velar DEX Farming (Testnet)"))
