;; Zest Protocol Lending Strategy - TESTNET VERSION
;; Simplified for testnet deployment

;; Error codes
(define-constant ERR_UNAUTHORIZED (err u7300))
(define-constant ERR_INSUFFICIENT_BALANCE (err u7301))
(define-constant ERR_STRATEGY_INACTIVE (err u7302))
(define-constant ERR_INVALID_AMOUNT (err u7303))

;; Config
(define-constant MIN_DEPOSIT u1000000)
(define-constant SIMULATED_APY u700) ;; 7% APY
...
;; Read-only
(define-read-only (get-name) (ok "Zest Protocol Lending (Testnet)"))
